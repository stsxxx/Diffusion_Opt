...
class NodeWorker:
    ...
    def fetch_and_process_requests(self):
        ...
        log_file = f"Throughput_LOG/Ours_throughput_{self.num_worker}gpus.log"
        while self.running:
            try:
                ...
                if request['k'] is None:
                    ...
                    generated_image_path = f"/work1/talati/stilex/diffusion_proj/multinode/throughput/images/Ours_{self.num_worker}gpus/{clean_prompt}.png"
                    try:
