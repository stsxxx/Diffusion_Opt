...
class NodeWorker:
    ...
    def fetch_and_process_requests(self):
        ...
        log_file = f"Throughput_LOG/NIRVANA_throughput.log"
        while self.running:
            try:
                ...
                cached_timestep=None ,labels_batch = 0, current_latents=latents, height=1024, width=1024)
                    ...
                    generated_image_path = f"/work1/talati/stilex/diffusion_proj/multinode/throughput/images/NIRVANA/{clean_prompt}.png"
                    try:
