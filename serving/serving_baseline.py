...
# Request scheduler
def request_scheduler(req_queue,  selected_requests, start_time, worker_status, log_file="request_throughput_Base_1000.csv"):
...
def worker(gpu_id, req_queue, latency_queue, worker_status):
    ...
    while True:
        try:
            ...
            generated_image_path = f"/data6/stilex/serving/baseline/{clean_prompt}.png"
