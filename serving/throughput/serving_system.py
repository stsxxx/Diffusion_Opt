...
def request_scheduler(
    ...
    cached_image_paths, shared_new_images, lock,  model, processor,worker_status,  num_gpus, cache_size=100000,  log_file="request_throughput_3000_ours.csv"
):
    ...
    while True:
        try:
            ...
            callback_on_step_end_tensor_inputs=["latents"])
                ...
                generated_image_path = f"/data6/stilex/throughput/Ours/{clean_prompt}.png"
...
if __name__ == "__main__":
    ...
    scheduler = mp.Process(target=request_scheduler, args=(
        hit_queue, nonhit_queue, selected_requests, start_time, request_rate_queue, final_image_embeddings, cached_image_paths, shared_new_images, lock, model, processor, worker_status, num_gpus
    ))
    scheduler.start()
    ...
    if all_latencies:
        ...
        throughput = num_requests / total_time * 60  # Requests per min
