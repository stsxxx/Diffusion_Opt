...
# Request scheduler
def request_scheduler(req_queue,  selected_requests, start_time, worker_status, num_gpus, log_file="request_throughput_Base_5000_1.csv"):
...
def worker(gpu_id, req_queue, latency_queue, worker_status):
    ...
    while True:
        try:
            ...
            generated_image_path = f"/data6/stilex/throughput/baseline1/{clean_prompt}.png"
