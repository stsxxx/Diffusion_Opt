...
# Request scheduler
def request_scheduler(req_queue,  selected_requests, start_time, index, cache, new_cache_queue, cached_requests, final_text_embeddings, k_values, processor, clip_model,  worker_status, num_gpus, log_file="request_throughput_3000_N.csv"):
    ...
    while True:
        try:
            ...
            if request['cached'] is None:
                ...
                generated_image_path = f"/data6/stilex/throughput/NIRVANA/{clean_prompt}.png"
...
if __name__ == "__main__":
    ...
    scheduler = mp.Process(target=request_scheduler, args=(req_queue,  selected_requests, start_time, index, cache,new_cache_queue,cached_requests, final_text_embeddings, k_values, processor, clip_model, worker_status, num_gpus))
