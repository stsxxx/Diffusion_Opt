...
# Request scheduler
def request_scheduler(req_queue,  selected_requests, start_time, index, cache, new_cache_queue, cached_requests, final_text_embeddings, k_values, processor, clip_model,  worker_status, log_file="request_throughput_N_1000_log2.csv"):
    ...
    while True:
        try:
            ...
            if request['cached'] is None:
                ...
                generated_image_path = f"/data6/stilex/serving/NIRVANA/nohit/{clean_prompt}.png"
                ...
                generated_image_path = f"/data6/stilex/serving/NIRVANA/hit/{clean_prompt}.png"
                try:
